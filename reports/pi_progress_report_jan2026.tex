...
\begin{enumerate}[label=\arabic*.]
    ...
    \begin{itemize}
        ...
        \item \textbf{Lid dynamics: 5VG3-like state throughout 10 ns}
    \end{itemize}
...
\textbf{Corrected interpretation:} Our simulation maintains the 5VG3-like ``closed-backbone / Glu162-out'' state. This is \textbf{not} the open-loop state (1J58, $\sim$15-16~\AA). The Glu162 sidechain is displaced from Mn, likely due to bidentate oxalate binding sterically forcing Glu162 out.
