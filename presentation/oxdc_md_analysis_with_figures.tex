...
%--------------------------------------------------------------
\begin{frame}{KEY FINDING: Lid Remains Fully Open}
\begin{columns}
\begin{column}{0.45\textwidth}
...
\vspace{0.5em}
\textbf{State Thresholds:}
\begin{itemize}
    \item Closed: $<$ 4 \angstrom
    \item Intermediate: 4-8 \angstrom
    \item Open: $>$ 8 \angstrom
\end{itemize}

\vspace{0.5em}
\textbf{Crystal structures:}
\begin{itemize}
    \item 5VG3 (closed): $\sim$2.4 \angstrom
    \item 1J58 (apo/open): $\sim$12 \angstrom
\end{itemize}
\end{column}
\begin{column}{0.55\textwidth}
\centering
...
\begin{center}
\Large
\textbf{The lid remains FULLY OPEN throughout 10 ns}

\vspace{0.5em}
\normalsize
(Glu162-Mn = 11.5 \angstrom, 100\% open, 0 transitions)
\end{center}
...
\vspace{0.5em}
\textbf{NEW:} 10 ns BiOx+2 production confirms lid remains \textbf{OPEN} (100\%)
\end{center}
\end{frame}
